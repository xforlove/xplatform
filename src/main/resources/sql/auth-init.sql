...
insert into app_function(id, code, name, level, action, stat_flag, parent_id, group_id) values(5, 'user:export', '用户导出', 2, '/auth/user-export', 'NORMAL', 1, 2);

insert into app_function(id, code, name, level, action, stat_flag, parent_id, group_id) values(6, 'role:list', '角色列表', 1, '/auth/role-list', 'NORMAL', NULL, 2);
insert into app_function(id, code, name, level, action, stat_flag, parent_id, group_id) values(7, 'role:create', '角色新增', 2, '/auth/role-input', 'NORMAL', 5, 2);
insert into app_function(id, code, name, level, action, stat_flag, parent_id, group_id) values(8, 'role:edit', '角色编辑', 2, '/auth/role-input', 'NORMAL', 5, 2);
insert into app_function(id, code, name, level, action, stat_flag, parent_id, group_id) values(9, 'role:remove', '角色删除', 2, '/auth/role-remove', 'NORMAL', 5, 2);

insert into app_function(id, code, name, level, action, stat_flag, parent_id, group_id) values(10, 'funcgroup:list', '功能组列表', 2, '/app/funcgroup-list', 'NORMAL', NULL, 2);
insert into app_function(id, code, name, level, action, stat_flag, parent_id, group_id) values(11, 'funcgroup:create', '功能组新增', 2, '/app/funcgroup-input', 'NORMAL', 9, 2);
insert into app_function(id, code, name, level, action, stat_flag, parent_id, group_id) values(12, 'funcgroup:edit', '功能组编辑', 2, '/app/funcgroup-input', 'NORMAL', 9, 2);
insert into app_function(id, code, name, level, action, stat_flag, parent_id, group_id) values(13, 'funcgroup:remove', '功能组删除', 2, '/app/funcgroup-remove', 'NORMAL', 9, 2);

insert into app_function(id, code, name, level, action, stat_flag, parent_id, group_id) values(14, 'function:list', '功能列表', 2, '/app/function-list', 'NORMAL', NULL, 2);
insert into app_function(id, code, name, level, action, stat_flag, parent_id, group_id) values(15, 'function:create', '功能新增', 2, '/app/function-input', 'NORMAL', 13, 2);
insert into app_function(id, code, name, level, action, stat_flag, parent_id, group_id) values(16, 'function:edit', '功能编辑', 2, '/app/function-input', 'NORMAL', 13, 2);
insert into app_function(id, code, name, level, action, stat_flag, parent_id, group_id) values(17, 'function:remove', '功能删除', 2, '/app/function-remove', 'NORMAL', 13, 2);
