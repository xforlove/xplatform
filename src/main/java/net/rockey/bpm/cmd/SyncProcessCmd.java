...
import net.rockey.bpm.graph.Node;
import net.rockey.bpm.manager.BpmConfBaseManager;
import net.rockey.bpm.manager.BpmConfCountersignManager;
import net.rockey.bpm.manager.BpmConfFormManager;
import net.rockey.bpm.manager.BpmConfListenerManager;
...
import net.rockey.bpm.model.BpmConfCountersign;
import net.rockey.bpm.model.BpmConfForm;
import net.rockey.bpm.model.BpmConfListener;
